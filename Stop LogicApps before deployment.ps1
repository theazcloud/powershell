Stop LogicApps before deployment
...
Set-AzLogicApp -ResourceGroupName $logicAppResourceGroupName -Name $logicApp1 -State "Disabled" -Force

Set-AzLogicApp -ResourceGroupName $logicAppResourceGroupName -Name $logicApp2 -State "Disabled" -Force
